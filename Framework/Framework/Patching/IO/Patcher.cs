...
namespace ConnectUO.Framework.Patching
{
	...
	public class Patcher
	{
        ...
        public string ServerFolder
        {
            ...
            {
                serverFolder = value;
                FileSystemHelper.EnsureDirectoryExists(serverFolder);
            }
        }

        public string PatchToFolder
        {
            get { return serverFolder; } 
        }
		...
		private string GetPath(string file)
		{
			if (File.Exists(Path.Combine(serverFolder, file)))
                ...
                return _settingsService.UltimaOnlineDirectory;
        }
        ...
        private void PatchFile(string idxPath, string mulPath, string newIdxPath, string newMulPath, List<Patch> patches)
        {
            ...
            FileIndex index = new FileIndex(_kernel, Path.GetFileName(idxPath), Path.GetFileName(mulPath), (int)(idxFileInfo.Length / 12));
